...
public class ZeroCopyByteBufferProcessor<T> {
    ...
    private final Function<ByteBuffer, T> transformer;
    ...
    public ZeroCopyByteBufferProcessor(Function<ByteBuffer, T> transformer,
        ...
        public void subscribe(Subscriber<? super T> subscriber) {
            byteBufferPublisher.subscribe(new Subscriber<ByteBuffer>() {
                ...
                public void onNext(ByteBuffer buffer) {
                    try {
                        T result = transformer.apply(buffer);
