...
public class CsvResult implements LeftoverProvider {
    ...
    public static reactive.async.csv.CsvResult fromByteBuffer(ByteBuffer buffer, byte delimiter, byte[] leftover) {
...
//            String leftoverString = new String(newLeftoverBytes, StandardCharsets.UTF_8);
        ...
        return new reactive.async.csv.CsvResult(lines, newLeftoverBytes);
